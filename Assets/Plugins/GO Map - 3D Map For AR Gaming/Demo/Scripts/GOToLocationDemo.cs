	...
	public class GOToLocationDemo : MonoBehaviour {
		...
		public void SearchAddress () {
			...
			if (goMap.mapType == GOMap.GOMapType.Mapzen_Legacy) {
				...
				if (goMap.locationManager.useLocationServices) {
					completeUrl += "&proximity=" + goMap.locationManager.currentLocation.latitude + "%2C" + goMap.locationManager.currentLocation.longitude;
				} else if (goMap.locationManager.demo_CenterWorldCoordinates != null){
					completeUrl += "&proximity=" + goMap.locationManager.demo_CenterWorldCoordinates.latitude + "%2C" + goMap.locationManager.demo_CenterWorldCoordinates.longitude;
				}
			}
